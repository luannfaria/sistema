<?php 
 return [ 
"stock_adjustment" => "Estoque",/* ATUALIZADO*/
...
"search_products" => "Buscar produtos", /* ATUALIZADO*/
"delete_success" => "Removido com sucesso",/* ATUALIZADO*/
"view_details" => "Detalhes ajuste estoque", /* ATUALIZADO*/
];